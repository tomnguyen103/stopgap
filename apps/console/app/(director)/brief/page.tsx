...
export default async function BriefPage() {
  // Guards itself rather than trusting the group layout: Next does not re-render a layout on a
  // soft navigation, so the layout's guard is what makes the redirect happen before chrome paints,
  // and THIS is what makes the page refuse.
