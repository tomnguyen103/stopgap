...
--
-- Tickets 09 and 12 took 0017 and 0018 while this branch was open. The journal and the snapshot
-- beside it were produced by `drizzle-kit generate` at 0019; what follows is this migration's own
-- hand-authored SQL, re-applied on top — `generate` emits table DDL and nothing else, and the
-- row-level-security policy below is the point of the file.
--
-- Ticket 09 merged with 0017 while this branch was open. The journal and the snapshot beside it
-- were produced by `drizzle-kit generate` at 0018; what follows is this migration's own
-- hand-authored SQL, re-applied on top — `generate` emits table DDL and nothing else, and the
-- row-level-security policies below are the point of the file.
--
